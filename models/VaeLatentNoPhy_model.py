...
class VaeLatentNoPhyModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='batch', netG='VaeLatentNoPhy',
                            dataset_mode='unalignedVelLatent2', ngf='32')
        if is_train:
