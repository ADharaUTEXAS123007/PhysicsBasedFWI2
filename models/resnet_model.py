...
class ResnetModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='batch', netG='resnet_6blocks', dataset_mode='unaligned2', ngf='32')
        return parser
    ...
    def compute_loss_only(self):
        lossL1 = self.criterionL1(self.fake_B,self.real_B)*100
        self.loss_V_L1 = lossL1
        print("Loss L1 : "+ str(lossL1.cpu().float().numpy()))
        lossRMSE = self.criterionRMSE(self.fake_B,self.real_B)
