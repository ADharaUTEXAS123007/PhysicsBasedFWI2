...
class AutoWavModel(BaseModel):
    ...
    def forward(self,epoch1,lstart):
        ...
        [self.fake_B,self.grad,self.latent,self.loss_D_MSE,self.down3,self.up2,self.up1] = self.netG(self.real_B,self.real_A,lstart,epoch1,self.latent,self.real_C,self.real_D)  # G(A)
