...
class AutoWavModel(BaseModel):
    ...
    def forward(self,epoch1,lstart):
        ...
        [self.fake_B,self.grad,self.latent,self.loss_D_MSE,self.down3,self.up2,self.up1] = self.netG(self.real_B,self.real_A,lstart,epoch1,self.latent,self.real_C,self.real_D[0,:,:,:],self.real_E[0,:,:,:],self.real_F[0,:,:,:])  # G(A)
    ...
    def forwardT(self):
        ...
        [self.fake_BT,self.gradT,self.latentT,_,_,_,_] = self.netG(self.real_B,self.real_A,False_lstart,False_epoch,self.latentT,self.real_C,self.real_D[0,:,:,:],self.real_E[0,:,:,:],self.real_F[0,:,:,:])  # G(A)
