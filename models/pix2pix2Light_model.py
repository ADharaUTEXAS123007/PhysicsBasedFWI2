...
class Pix2Pix2LightModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='batch', netG='unet_128', dataset_mode='unaligned2', ngf='16')
        if is_train:
    ...
    def compute_loss_only(self):
        lossL1 = self.criterionL1(self.fake_BT,self.real_BT) * self.opt.lambda_L1
