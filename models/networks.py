...
class Auto_Net(nn.Module):
    def __init__(self,outer_nc, inner_nc, input_nc=None,
        ...
        self.decoder_input1 = nn.Linear(filters[2]*50*13, latent_dim) #for marmousi 101x101
...
class VaeNormalizing_Net(nn.Module):
    def __init__(self, outer_nc, inner_nc, input_nc=None,
        ...
        self.flow = NormalizingFlow(dim=6, blocks=[PlanarFlow], flow_length=6, density=distrib.MultivariateNormal(torch.zeros(2), torch.eye(2)))
