...
class AutoSEAMMar22_Net(nn.Module):
    ...
    def prop(self, vp1, vs1, rho1, true, epoch1, freq, idx, it):
        ...
        denise_root = '/disk/student/adhara/WORK/DeniseFWI/virginFWI/DENISE-Black-Edition/'
        d = api.Denise(denise_root,verbose=1)
        d.save_folder = '/disk/student/adhara/SEAM/'
        d.set_paths()
        ...
        os.system('rm -rf /disk/student/adhara/SEAM/su1')
        os.system('mkdir /disk/student/adhara/SEAM/su1')
        def copyshot(id1, value):             
            fo = 'cp /disk/student/adhara/SEAM/su/seis_x.su.shot'+str(id1+1)+ ' ' + '/disk/student/adhara/SEAM/su1/.'
            os.system(fo)
            fo = 'cp /disk/student/adhara/SEAM/su/seis_y.su.shot'+str(id1+1)+ ' ' + '/disk/student/adhara/SEAM/su1/.'
            os.system(fo)
        #      #if (id1+1 != value+1):
            fo = 'mv /disk/student/adhara/SEAM/su1/seis_x.su.shot'+str(id1+1)+' ' + '/disk/student/adhara/SEAM/su1/seisT_x.su.shot' + str(value+1)
            os.system(fo)
            fo = 'mv /disk/student/adhara/SEAM/su1/seis_y.su.shot'+str(id1+1)+' ' + '/disk/student/adhara/SEAM/su1/seisT_y.su.shot' + str(value+1)
            os.system(fo)
        # # #pool = ThreadPool(tshots)
        #values = np.arange(0,tshots)
        #print("values :", values)
        ...
        for i in range(0,tshots):
            print("idx :", idx[i])
            copyshot(idx[i],i)
        d.DATA_DIR = '/disk/student/adhara/SEAM/su1/seisT'
        d.SEIS_FILE_VX = 'su1/seisT_x.su'
        d.SEIS_FILE_VY = 'su1/seisT_y.su'
