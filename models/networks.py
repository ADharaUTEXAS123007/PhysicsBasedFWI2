...
class AutoElFullMarmousiMar22_Net(nn.Module):
    ...
    def prop(self, vp1, vs1, rho1, true, epoch1, freq, idx, it):
        ...
        denise_root = '/disk/student/adhara/WORK/DeniseFWI/virginFWI/DENISE-Black-Edition/'
        d = api.Denise(denise_root,verbose=1)
        d.save_folder = '/disk/student/adhara/MARMOUSILin/'
        d.set_paths()
        ...
        os.system('rm -rf /disk/student/adhara/MARMOUSILin/su1')
        os.system('mkdir /disk/student/adhara/MARMOUSILin/su1')
        def copyshot(id1, value):             
            fo = 'cp /disk/student/adhara/MARMOUSILin/su/seis_x.su.shot'+str(id1+1)+ ' ' + '/disk/student/adhara/MARMOUSILin/su1/.'
            os.system(fo)
            fo = 'cp /disk/student/adhara/MARMOUSILin/su/seis_y.su.shot'+str(id1+1)+ ' ' + '/disk/student/adhara/MARMOUSILin/su1/.'
            os.system(fo)
        #      #if (id1+1 != value+1):
            fo = 'mv /disk/student/adhara/MARMOUSILin/su1/seis_x.su.shot'+str(id1+1)+' ' + '/disk/student/adhara/MARMOUSILin/su1/seisT_x.su.shot' + str(value+1)
            os.system(fo)
            fo = 'mv /disk/student/adhara/MARMOUSILin/su1/seis_y.su.shot'+str(id1+1)+' ' + '/disk/student/adhara/MARMOUSILin/su1/seisT_y.su.shot' + str(value+1)
            os.system(fo)
        # # #pool = ThreadPool(tshots)
        #values = np.arange(0,tshots)
        #print("values :", values)
        ...
        for i in range(0,tshots):
            print("idx :", idx[i])
            copyshot(idx[i],i)
        d.DATA_DIR = '/disk/student/adhara/MARMOUSILin/su1/seisT'
        d.SEIS_FILE_VX = 'su1/seisT_x.su'
        d.SEIS_FILE_VY = 'su1/seisT_y.su'
        ...
        #d.forward(model, src, rec)
        #os.system('mpirun -np 4 hello')
        filen = './marmousiEl29June/vpmod' + str(epoch1) + '.npy' #switch on for physics based fwi         
        np.save(filen, vpst)  #switch on physics based fwi
        
        filen = './marmousiEl29June/vsmod' + str(epoch1) + '.npy' #switch on for physics based fwi     
        np.save(filen, vsst)  #switch on physics based fwi
        
        filen = './marmousiEl29June/rhomod' + str(epoch1) + '.npy' #switch on for physics based fwi     
        np.save(filen, rhost)  #switch on physics based fwi
        ...
        filen = './marmousiEl29June/vpp' + str(epoch1) + '.npy' #switch on for physics based fwi       
        np.save(filen, vp_grad)  #switch on physics based fwi
        
        filen = './marmousiEl29June/vss' + str(epoch1) + '.npy' #switch on for physics based fwi       
        np.save(filen, vs_grad)  #switch on physics based fwi
        
        filen = './marmousiEl29June/rhoo' + str(epoch1) + '.npy' #switch on for physics based fwi       
        np.save(filen, rho_grad)  #switch on physics based fwi
...
class AutoElFullRhoMarmousiMar22_Net(nn.Module):
    ...
    def prop(self, vp1, vs1, rho1, true, epoch1, freq, idx, it):
        ...
        #d.add_fwi_stage(fc_low=0.0, fc_high=int(epoch1/10)+1.0)
        #d.add_fwi_stage(fc_low=0.0, fc_high=30.0)
        d.add_fwi_stage(fc_low=2.0,fc_high=15)
        # if ((epoch1 >= 0) and (epoch1 <=100 )):
        #     d.add_fwi_stage(fc_low=0.0, fc_high=2.0)
        # #     #print(f'Stage {i+1}:\n\t{d.fwi_stages[i]}\n')
        # elif ((epoch1 >= 101) and (epoch1 <=200)):
...
class AutoSEAMMar22_Net(nn.Module):
    ...
    def prop(self, vp1, vs1, rho1, true, epoch1, freq, idx, it, nnz):
        ...
        os.system('rm -rf /disk/student/adhara/SEAMT/su1')
        os.system('mkdir /disk/student/adhara/SEAMT/su1')
        def copyshot(id1, value):             
            fo = 'cp /disk/student/adhara/SEAMT/su/seis_x.su.shot'+str(id1+1)+ ' ' + '/disk/student/adhara/SEAMT/su1/.'
            os.system(fo)
            fo = 'cp /disk/student/adhara/SEAMT/su/seis_y.su.shot'+str(id1+1)+ ' ' + '/disk/student/adhara/SEAMT/su1/.'
            os.system(fo)
        #      #if (id1+1 != value+1):
            fo = 'mv /disk/student/adhara/SEAMT/su1/seis_x.su.shot'+str(id1+1)+' ' + '/disk/student/adhara/SEAMT/su1/seisT_x.su.shot' + str(value+1)
            os.system(fo)
            fo = 'mv /disk/student/adhara/SEAMT/su1/seis_y.su.shot'+str(id1+1)+' ' + '/disk/student/adhara/SEAMT/su1/seisT_y.su.shot' + str(value+1)
            os.system(fo)
        # # #pool = ThreadPool(tshots)
        #values = np.arange(0,tshots)
        #print("values :", values)
        ...
        for i in range(0,tshots):
            print("idx :", idx[i])
            copyshot(idx[i],i)
        d.DATA_DIR = '/disk/student/adhara/SEAMT/su1/seisT'
        d.SEIS_FILE_VX = 'su1/seisT_x.su'
        d.SEIS_FILE_VY = 'su1/seisT_y.su'
        ...
        filen = './marmousiSEAM9July/vpp' + str(epoch1) + '.npy' #switch on for physics based fwi       
        np.save(filen, vp_grad)  #switch on physics based fwi
        
        filen = './marmousiSEAM9July/vss' + str(epoch1) + '.npy' #switch on for physics based fwi       
        np.save(filen, vs_grad)  #switch on physics based fwi
        
        filen = './marmousiSEAM9July/rhoo' + str(epoch1) + '.npy' #switch on for physics based fwi       
        np.save(filen, rho_grad)  #switch on physics based fwi
