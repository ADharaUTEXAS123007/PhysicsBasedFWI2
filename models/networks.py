...
class AutoSEAMMar22_Net(nn.Module):
    ...
    def prop(self, vp1, vs1, rho1, true, epoch1, freq, idx, it, nnz):
        ...
        def copyshot(id1, value):             
            fo = 'cp /disk/student/adhara/SEAMT/su/seis_x.su.shot'+str(id1+1)+ ' ' + '/disk/student/adhara/SEAMN/su1/.'
            os.system(fo)
            fo = 'cp /disk/student/adhara/SEAMT/su/seis_y.su.shot'+str(id1+1)+ ' ' + '/disk/student/adhara/SEAMN/su1/.'
            os.system(fo)
        #      #if (id1+1 != value+1):
            fo = 'mv /disk/student/adhara/SEAMT/su1/seis_x.su.shot'+str(id1+1)+' ' + '/disk/student/adhara/SEAMN/su1/seisT_x.su.shot' + str(value+1)
            os.system(fo)
            fo = 'mv /disk/student/adhara/SEAMT/su1/seis_y.su.shot'+str(id1+1)+' ' + '/disk/student/adhara/SEAMN/su1/seisT_y.su.shot' + str(value+1)
            os.system(fo)
        # # #pool = ThreadPool(tshots)
        #values = np.arange(0,tshots)
        #print("values :", values)
