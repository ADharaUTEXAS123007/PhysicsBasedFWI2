...
class Pix2Pix2BDEASPPModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='batch', netG='ASPP', dataset_mode='unalignedBDE2', ngf='32')
        if is_train:
    ...
    def backward_G(self):
        ...
        # Second, G(A) = B
        self.loss_G_L1 = (self.criterionL1(self.fake_B*self.real_E, self.real_B*self.real_E))*10
        # combine loss and calculate gradients
