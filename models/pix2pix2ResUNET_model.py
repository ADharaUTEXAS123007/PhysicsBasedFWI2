...
from custom_losses import LpLoss


class Pix2Pix2ResUNETModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='batch', netG='resunet', dataset_mode='unaligned2', ngf='32')
        if is_train:
    ...
    def forwardT(self):
        ...
        #print("max fake_BT")
        #print(torch.max(self.fake_BT))
        #print("min fake_BT")
        #print(torch.min(self.fake_BT))
    ...
    def compute_loss_only(self):
        lossL1 = self.criterionL1(self.fake_BT,self.real_BT) *1000
