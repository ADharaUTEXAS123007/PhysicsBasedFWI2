...
class Auto2Model(BaseModel):
    ...
    def forward(self,epoch1,lstart):
        ...
        [self.fake_B,self.grad] = self.netG(self.real_B,self.real_A,lstart,epoch1,self.latent,self.real_C)  # G(A)
    ...
    def forwardT(self):
        ...
        [self.fake_BT,self.gradT] = self.netG(self.real_B,self.real_A,False_lstart,False_epoch,self.latentT,self.real_C)  # G(A)
