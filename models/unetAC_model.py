...
class UnetACModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='batch', netG='unet_128', dataset_mode='unalignedAC2', ngf='32')
        return parser
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['fake_C_1T', 'real_C_1T', 'fake_C_2T', 'real_C_2T']
        #self.visual_names = []
