...
class New1UModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.device1 = torch.device('cuda:{}'.format(0)) if self.gpu_ids else torch.device('cpu') 
        self.device2 = torch.device('cuda:{}'.format(1)) if self.gpu_ids else torch.device('cpu') 
