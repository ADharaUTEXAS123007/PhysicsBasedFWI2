...
class PiMultiASPPModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['fake_B1','real_B1','fake_B2','real_B2','fake_B1T', 'real_B1T','fake_B2T','real_B2T']
    ...
    def backward_G(self):
        ...
        # Second, G(A) = B
        self.loss_G_L1 = (self.criterionL1(self.fake_B1T, self.real_B1T))*10 + (self.criterionL1(self.fake_B2T, self.real_B2T))*10
        # combine loss and calculate gradients
